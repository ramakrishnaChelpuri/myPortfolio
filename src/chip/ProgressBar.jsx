...
const ProgressBar = ({ logo, name, value, duration = 3 }) => {
  return (
    <div className="flex flex-col gap-2 sm:gap-1 text-xl font-semibold ">
      ...
      <div className="h-[8px] w-[100%] relative hover:scale-125 rounded-3xl bg-gray-300">
        <Progress
          className="w-[0%] h-[8px] absolute rounded-3xl bg-gradient-to-r from-green-300 to-blue-300"
          style={{
            width: `${value}%`,
